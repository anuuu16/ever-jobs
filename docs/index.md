...
| 003 | [Job Deduplication Engine](../.specify/specs/003-deduplication-engine/spec.md) — [plan](../.specify/specs/003-deduplication-engine/plan.md) — [tasks](../.specify/specs/003-deduplication-engine/tasks.md) | Phase 1 + 2 done (T01–T05); Phase 3 (`dedup-hybrid` plugin) next |
...
_Last revised: 2026-04-26 (run #3)._
